...
tags:
  ...
  - indexation
  - performance
image: ../../assets/articles/improve-core-web-vitals-howto/hero.png
...
draft: true
internalLinks:
  - label: Technical SEO Foundations for Durable Search Visibility
    url: /articles/technical-seo-foundations/
  - label: Core Web Vitals Guide for Technical SEO and Real-User Data
    url: /articles/core-web-vitals-complete-guide/
externalLinks: []
faqs:
...
Related reading: [Technical SEO Foundations for Durable Search Visibility](/articles/technical-seo-foundations/), [Core Web Vitals Guide for Technical SEO and Real-User Data](/articles/core-web-vitals-complete-guide/).
